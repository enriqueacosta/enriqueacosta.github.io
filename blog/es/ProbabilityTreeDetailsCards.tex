...
\draw[thick]%
   ...
   -- node[above, sloped, align=center]
      {1st is $\heartsuit$\\($1/4=25\%$)} 
   (\wideOne,\distOne);
\draw[thick] 
   (0,0) 
   -- node[below, sloped, align=center]
      {1st is not $\heartsuit$\\($3/4=75\%$)} 
   (\wideOne,-\distOne);
...
\draw[thick] 
   ...
   -- node[above, align=center, sloped]
      {2nd is $\heartsuit$\\($12/51=23.53\%$)}
   ++ (\wideTwo,\distTwo) 
      node[right, align=center, text width=\wideThree]
      {1st is $\heartsuit$ and\\2nd is $\heartsuit$}
   ++ (\wideFour,0) 
      node[right]
      {$(1/4)\times(12/51)=5.88\%$}
   ++ (0.3,1)
...
\draw[thick] 
   ...
   -- node[below, align=center, sloped]
      {2nd is not $\heartsuit$\\($39/51=76.47\%$)}
   ++ (\wideTwo,-\distTwo) 
      node[right, align=center, text width=\wideThree]
...
\draw[thick] 
   (\wideOne,-\distOne)
   -- node[below, align=center, sloped]
      {2nd is not $\heartsuit$\\($38/51=74.51\%$)}
   ++ (\wideTwo,-\distTwo) 
      node[right, align=center, text width=\wideThree]
