...
\draw[very thick, blue] 
   ...
   -- node[above, align=center, sloped]
      {\textcolor{black}{prueba da positivo}\\{\bf(sensibilidad $a\%$)}}
   ++ (\wideTwo,\distTwo) 
      node[right, align=center, text width=\wideThree]
      {\textcolor{black}{verdadero positivo}}
   ; 
\draw[thick] 
   (\wideOne,\distOne) 
...
\draw[very thick, blue] 
   (\wideOne,-\distOne)
   -- node[below, align=center, sloped]
      {\textcolor{black}{prueba da negativo}\\{\bf(especificidad $b\%$)}}
   ++ (\wideTwo,-\distTwo) 
      node[right, align=center, text width=\wideThree]
      {\textcolor{black}{verdadero negativo}}
   ; 
\end{tikzpicture}
\end{document}
