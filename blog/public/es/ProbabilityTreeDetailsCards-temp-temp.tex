% % % 
% % % temp file written by script on Thu Feb 24 15:41:38 2022
...
++ (\wideTwo,-\distTwo)
node[right, align=center, text width=\wideThree]
{heart and then not red}
++ (\wideFour,0)
node[right]
{prob $=(1/4)\times(26/51)=12.75\%$}
;
\draw[thick]
(\wideOne,-\distOne)
-- node[above, align=center, sloped]
...
++ (\wideTwo,-\distTwo)
node[right, align=center, text width=\wideThree]
{not a heart and then not red}
++ (\wideFour,0)
node[right]
{prob $=(3/4)\times(49.67\%)=37.25\%$}
;
\end{tikzpicture}
\end{document}
